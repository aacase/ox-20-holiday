...
var ctx = document.getElementById("mobileCanvas").getContext("2d"); //this grabs the element line sets it as a two dimentional plane
...
background.onload = function () {
    ...
    photo.src = "images/mobileGlobe.png" // after background is loaded, load foreground
}
photo.onload = function () {
    ctx.drawImage(photo, 0, 0, 375, 667);
 ...
 //this is down here so we don't have to do a messy callback.
   background.src = document.getElementById('frame').src;

// Now we need a way to download it
function downloadCanvas() {
  
    var globeCanvas = document.getElementById('mobileCanvas'); //grab our combined pictures
